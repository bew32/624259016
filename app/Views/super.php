...
<html>
    ...
    <br>
    <center><h2>Super VIP</h2></center>
    <center><div class="card mb-5" style="max-width: 1000px;">
    <div class="row g-0">
        <div class="col-md-4">
        <img src="https://bimmer-th.com/wp-content/uploads/2018/02/SO-FIT-SO-Fun-Run-Press-Release-1920x1080.jpg" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
        <div class="card-body">
            <h5 class="card-title">Super VIP</h5>
            <p class="card-text">เรียกได้ว่าเป็นขั้น Advance ของการวิ่งมาราธอน ระยะทางเกินกว่า 42.195 กิโลเมตร เหมาะสำหรับคนที่เอาชนะการวิ่งมาราอนมาแล้ว อยากขยับตัวเองไปสู่เส้นทางที่ไกลกว่า พัฒนาศักยภาพตัวเองให้สูงขึ้น หรือท้าทายขีดจำกัดร่างกายของตัวเอง นักวิ่งอัลตร้า มาราธอน ส่วนใหญ่มักเป็นผู็แข็งแกร่ง ผ่านสนามวิ่งมาอย่างโชกโชน เป็นการแข่งขันที่คัดเอาคนระดับสุดยอดมารวมกัน ไม่แนะนำสำหรับผู้หัดวิ่งใหม่ๆ</p>
            <p class="card-text"><small class="text-muted">สมัครเข้าร่วมกิจกรรมได้เเล้วตั้งเเต่ 16/พ.ย./2564 ถึง 19/พ.ย./2564</small></p>
