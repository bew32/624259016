...
<html>
    ...
    <br>
    <center><h2>VIP</h2></center>
    <center><div class="card mb-5" style="max-width: 1000px;">
    <div class="row g-0">
        <div class="col-md-4">
        <img src="https://previous.thanyapura.com/wp-content/uploads/2019/01/banner-cfr.jpg" class="img-fluid rounded-start" alt="...">
        </div>
        <div class="col-md-8">
        <div class="card-body">
            <h5 class="card-title">VIP</h5>
            <p class="card-text">** สิ่งที่ประเภท VIP จะได้รับ    <br>
                1. เสื้อที่ระลึก 1 ตัว    <br>
                2. เหรียญ 1 เหรียญ    <br>
                3. ป้ายติดหน้าอก VIP   <br>
                4. เลือกร่วมวิ่ง ระยะใดก็ได้ ในวันงาน <br> ( รับเหรียญในวันงาน) หรือ หากไม่ได้มาร่วมงาน ทางผู้จัดงานจะจัดส่งของทั้งหมด ให้หลังจากการจัดงานเสร็จสิ้น</p>
            <p class="card-text"><small class="text-muted">สมัครเข้าร่วมกิจกรรมได้เเล้วตั้งเเต่ 13/พ.ย./2564 ถึง 15/พ.ย./2564</small></p>
